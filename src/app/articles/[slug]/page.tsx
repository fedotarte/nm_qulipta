            ...
            <section className={styles.mainColumn}>
              ...
              <article className={styles.section}>
                <h2 className={styles.sectionTitle}>
                  КЬЮЛИПТА ОБЛАДАЕТ ВЫСОКИМ СРОДСТВОМ К CGRP-РЕЦЕПТОРУ{" "}
                  <sup className={styles.sectionSup}>1, 2</sup>
                </h2>
                <LightboxImage
              ...
              <article className={styles.section}>
                <h2 className={styles.sectionTitle}>
                  У КАЖДОГО ВТОРОГО ПАЦИЕНТА К КОНЦУ 1 ГОДА ТЕРАПИИ
                  ЗАФИКСИРОВАНО ПОЛНОЕ ПРЕКРАЩЕНИЕ ПРИСТУПОВ
                </h2>
                <LightboxImage
              ...
              <article className={styles.section}>
                <h2 className={styles.sectionTitle}>
                  ПРОФИЛАКТИЧЕСКАЯ ТЕРАПИЯ МИГРЕНИ, КОТОРАЯ ХОРОШО ПЕРЕНОСИТСЯ
                      ...
                      <ul className={styles.aeFacts}>
                        <li>
                          ...
                          <p>
                            ...
                            характеризовался хорошей переносимостью по сравнению
              ...
              <section className={styles.disclaimer}>
                ...
                <br />
                <br />
                *Ki - константа ингибирования рецептора, является мерой сродства
                ингибитора к рецептору и показывает, насколько сильно ингибитор
                подавляет активность рецептора. Низкая Ki указывает на сильное
                сродство ингибитора к рецептору, требуется меньшая концентрация
                ингибитора для достижения того же уровня ингибирования.
                <br />
                ...
                <br />‡ - *0% приступов определяется как 0 дней с мигренью в
